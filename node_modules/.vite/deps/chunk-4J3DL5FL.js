...
var _a;
var IS_WEBKIT = IN_BROWSER && ((_a = CSS == null ? void 0 : CSS.supports) == null ? void 0 : _a.call(CSS, "-webkit-backdrop-filter", "none"));
...
function focusableChildren(el) {
  ...
  return elements.filter((x) => !x.closest("[inert]")).filter((x) => !!x.offsetParent || x.getClientRects().length > 0).filter((x) => {
    var _a2, _b;
    return !((_a2 = x.parentElement) == null ? void 0 : _a2.closest("details:not([open])")) || x.tagName === "SUMMARY" && ((_b = x.parentElement) == null ? void 0 : _b.tagName) === "DETAILS";
  });
}
...
function focusChild(el, location, options) {
  ...
  if (location == null) {
    ...
    if (el === active || !el.contains(active)) {
      (_a2 = focusable[0]) == null ? void 0 : _a2.focus(options);
    }
...
function findCachedComparison(a, b, cache) {
  ...
  const r1 = (_a2 = cache.get(a)) == null ? void 0 : _a2.get(b);
...
//# sourceMappingURL=chunk-4J3DL5FL.js.map
