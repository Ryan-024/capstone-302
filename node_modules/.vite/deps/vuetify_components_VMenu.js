...
import "/Users/ryan.dampf/vibe codes/capstone-302/node_modules/vuetify/lib/components/VMenu/VMenu.css";

// node_modules/vuetify/lib/components/VOverlay/VOverlay.js
import "/Users/ryan.dampf/vibe codes/capstone-302/node_modules/vuetify/lib/components/VOverlay/VOverlay.css";
...
function useActivator(props, _ref) {
  ...
  watch(isTop, (val) => {
    var _a;
    if (val && (props.openOnHover && !isHovered && (!openOnFocus.value || !isFocused) || openOnFocus.value && !isFocused && (!props.openOnHover || !isHovered)) && !((_a = contentEl.value) == null ? void 0 : _a.contains(getActiveElement()))) {
      runCloseDelay();
    }
  });
  watch(isActive, (val) => {
...
function onKeydown(e) {
  ...
  if (e.shiftKey && (activeElement === firstElement || firstElement.classList.contains("v-list") && firstElement.contains(activeElement))) {
    e.preventDefault();
    lastElement.focus();
  }
  if (!e.shiftKey && (activeElement === lastElement || lastElement.classList.contains("v-list") && lastElement.contains(activeElement))) {
    e.preventDefault();
    firstElement.focus();
  }
}
  ...
  setup(props, _ref) {
    ...
    function onKeydown2(e) {
      ...
      if (e.key === "Escape" && globalTop.value) {
        if (!((_a = contentEl.value) == null ? void 0 : _a.contains(getActiveElement()))) {
          emit("keydown", e);
        }
        if (!props.persistent) {
          isActive.value = false;
          if ((_b = contentEl.value) == null ? void 0 : _b.contains(getActiveElement())) {
