...
import { genericComponent, getActiveElement, omit, propsFactory, useRender } from "../../util/index.js"; // Types
    ...
    useRender(() => {
      ...
      return _createVNode(VDialog, _mergeProps({
        ...
        default: () => _createVNode(VSheet, {
          ...
          }, [slots['list.prepend']?.(), filteredItems.value.length > 0 ? _createVNode(VList, _mergeProps({
            "key": "list",
